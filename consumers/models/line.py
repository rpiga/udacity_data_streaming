...
class Line:
    ...
    def _handle_arrival(self, message):
        ...
        value = message.value()
        logger.info("DEBUG handled 2: %s", value)
    ...
    def process_message(self, message):
        ...
        logger.info(f"DEBUG (line 1) {topic} {message}")
        
        if topic == "connect.stations.table": # Set the conditional correctly to the stations Faust Table
            try:
