...
class KafkaConsumer:
    ...
    def __init__(
        ...
        #
        #
        ##print(f"DEBUG (consumer 1) offset_earliest: {self.offset_earliest} ({OFFSET_BEGINNING})")
        ...
        if is_avro is True:
            ...
            ##pass
        ##print(f"DEBUG (consumer 2): {self.broker_properties}")
        #
        #
        ...
        #
        #
        logger.info("%s", [self.topic_name_pattern])
    ...
    async def consume(self):
        ...
        while True:
            ...
            while num_results > 0:
                ...
                ##logger.info(f"DEBUG (consumer 3) {num_results}")
    ...
    def _consume(self):
        ...
        while True:
            ...
            if message is None:
                ...
                try:
                    logger.info(f"message {message.key()}: {message.value()}")
                    return 1
