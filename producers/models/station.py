...
class Station(Producer):
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        print("DEBUG (station 1): ", train, direction, prev_station_id, prev_direction)
        #
        #
        ...
        print(f"DEBUG (station 2): {self.station_id, train, direction, self.color.name, train.status.name, prev_station_id, prev_direction}, ")
    ...
    def arrive_b(self, train, prev_station_id, prev_direction):
        ...
        print("DEBUG (station 3): ", train, prev_station_id, prev_direction)
        self.b_train = train
